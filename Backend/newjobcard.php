...
<div class="main-content">
  <section class="section">
    ...
    <?php
            ...
            $selectmenulist="SELECT * FROM `openporawdata` where `status`='0' ORDER BY `openporawdata`.`deliverydate` ASC;";
                ...
                {?>
                    <tr>
                      ...
                      <?php
                            ...
                            { ?>
                            <td class="text-success">
                            <button class="btn btn-primary " onclick="createjobcard(<?php echo $row['id'];?>,'<?php echo $row['itemcode']; ?>')">Create job card</button>
                            </td>
                            <?php }else 
                            { ?>

                            <td id="txtitemnotexist">
                            <button class="btn btn-primary disabled" onclick="createjobcard(<?php echo $row['id'];?>,'<?php echo $row['itemcode']; ?>')">Create job card</button>
                            </td>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="">
                  <label for="">Itemcode for Jobcard</label>
              ...
              <div class="modal-footer bg-whitesmoke br">
                <button type="button" class="btn btn-primary" onclick="createnewjobcard()">Save</button>
...
function createjobcard(jocno,itemcode)
    {
            //  alert(jocno);
